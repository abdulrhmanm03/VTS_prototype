...
const reports = [
  ...
  { title: "Compliance Gap Analysis", date: "Aug 05, 2025", type: "Compliance" },
]
...
export default function RiskReports() {
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-gray-400">Access historical and compliance reports</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {reports.map((r) => (
          ...
          >
            <CardHeader>
              <CardTitle className="text-blue-400 text-base">{r.title}</CardTitle>
