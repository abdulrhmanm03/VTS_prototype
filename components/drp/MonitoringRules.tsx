  ...
  return (
    <div className="space-y-4 mt-6">
      ...
      <p className="text-sm text-gray-400">
        Create and manage your automated detection rules
      </p>
      ...
      <Card className="bg-white/5 border-none rounded-2xl backdrop-blur-md shadow-lg p-4">
        <div className="flex space-x-2 mb-4">
          ...
          />
          <Input
            placeholder="Condition (e.g., domain contains 'secure')"
            className="bg-white/10 border-none text-white flex-1"
          />
      ...
      {[
        ...
        <Card
          key={i}
          className="bg-white/5 border-none rounded-2xl backdrop-blur-md shadow-lg hover:shadow-[0_0_20px_rgba(59,130,246,0.4)] transition-shadow duration-300"
        >
