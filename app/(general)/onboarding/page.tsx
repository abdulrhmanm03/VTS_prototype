        ...
        <Card className="relative border-none text-white overflow-hidden rounded-2xl bg-white/5 shadow-lg backdrop-blur-md 
          ...
          <div className="relative z-10">
            <CardHeader className="flex flex-col items-center text-center space-y-2 pb-2">
              ...
              <CardTitle className="text-lg font-semibold text-gray-200">Discover</CardTitle>
            </CardHeader>
            <CardContent className="text-center text-gray-400 text-sm">
              Automatically find all assets in your environment: domains, IPs, and services.
            </CardContent>
          </div>
        </Card>
        ...
        <Card className="relative border-none text-white overflow-hidden rounded-2xl bg-white/5 shadow-lg backdrop-blur-md 
          ...
          <div className="relative z-10">
            <CardHeader className="flex flex-col items-center text-center space-y-2 pb-2">
              ...
              <CardTitle className="text-lg font-semibold text-gray-200">Assess</CardTitle>
            </CardHeader>
            <CardContent className="text-center text-gray-400 text-sm">
              Evaluate vulnerabilities and risks associated with your exposed assets.
            </CardContent>
          </div>
        </Card>
        ...
        <Card className="relative border-none text-white overflow-hidden rounded-2xl bg-white/5 shadow-lg backdrop-blur-md 
          ...
          <div className="relative z-10">
            <CardHeader className="flex flex-col items-center text-center space-y-2 pb-2">
              ...
              <CardTitle className="text-lg font-semibold text-gray-200">Monitor</CardTitle>
            </CardHeader>
            <CardContent className="text-center text-gray-400 text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="bg-white/5 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-[0_0_20px_rgba(59,130,246,0.4)] transition-shadow">
            <CardContent className="p-6 text-center space-y-2">
              ...
              <Button variant="outline" className="bg-white/10 border-none">View Guide</Button>
            </CardContent>
          </Card>
        </div>
      </div>
