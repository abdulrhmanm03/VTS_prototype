    ...
    <div className="flex flex-col gap-6 p-6 min-h-screen text-white">
      ...
      <div className="mb-6">
        ...
        <div className="ml-2">
          <p className="text-gray-400">
            Monitor criminal marketplaces, forums, and ransomware activities
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          },
          {
            ...
            icon: MessageSquare,
            gradient: "from-green-900/20 via-green-800/10",
          },
          {
            title: "Ransomware Victims",
            value: "12",
            sub: "3 in your industry",
            icon: Lock,
          ...
          },
          {
            title: "Threat Level",
            value: "High",
            sub: "Elevated activity detected",
            icon: AlertTriangle,
          ...
          <Card
            key={i}
            className="relative border-none text-white overflow-hidden rounded-2xl bg-white/5 shadow-lg backdrop-blur-md hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] transition-shadow duration-300"
          >
            <div
              className={`absolute inset-0 bg-gradient-to-br ${item.gradient} to-transparent pointer-events-none`}
            />
        ...
        <div className="relative z-10">
          <CardHeader>
            <CardTitle className="text-lg font-semibold">
              Dark Web Activity Trend
            </CardTitle>
            <p className="text-sm text-gray-400">
              Mentions and threats detected over the last 7 days
            </p>
          </CardHeader>
          <CardContent>
      ...
      <Tabs defaultValue="marketplace-monitoring" className="mt-4">
        <TabsList className="bg-white/10 p-1 rounded-lg">
          <TabsTrigger value="marketplace-monitoring">
            Marketplace Monitoring
          </TabsTrigger>
          <TabsTrigger value="forum-analysis">Forum Analysis</TabsTrigger>
          <TabsTrigger value="ransomware-intelligence">
        ...
        <TabsContent value="marketplace-monitoring" className="space-y-4 mt-6">
          ...
          <p className="text-sm text-gray-400">
            Track stolen data, malware, and illegal services
          </p>
            ...
            <div className="relative z-10">
              <CardContent className="flex items-center justify-between p-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-gray-400">
                    Marketplace: DarkMarket Alpha · Price: $2,500 · Seller:
                    DataBroker99 · Detected: 2024-01-20
                  </p>
                </div>
